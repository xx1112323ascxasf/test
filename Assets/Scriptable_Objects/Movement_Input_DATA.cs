...
namespace Marchenkostuff
{
    ...
    [CreateAssetMenu(fileName = "MovementInput_Data", menuName = "FirstPersonController/Data/MovementInputData", order = 1)]
    public class Movement_input_DATA : ScriptableObject
    {
